...
from random import *
wb = Workbook() # sample.xlsx 파일에서 wb을 불러옴
ws = wb.active
...
# from openpyxl.utils.cell import coordinate_from_string # 좌표값 가져오기
...
# 전체 rows
# print(tuple(ws.rows)) # 한줄을 묶어서 표시
